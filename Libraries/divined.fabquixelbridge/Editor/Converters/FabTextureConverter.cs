...
public static class FabTextureConverter
{
	...
	private static void CreateVtexFile( string imagePath, string vtexPath, FabTexture fabTexture )
	{
		...
		var textureFile = new TextureInspector.TextureFile
		{
			Sequences = new List<TextureInspector.TextureFile.TextureSequence>
			{
				new TextureInspector.TextureFile.TextureSequence
				{
					Source = relativePath,
					IsLooping = true
				}
			},
			InputColorSpace = isLinear ? TextureInspector.TextureFile.GammaType.Linear : TextureInspector.TextureFile.GammaType.SRGB,
			OutputColorSpace = TextureInspector.TextureFile.GammaType.Linear,
			OutputFormat = TextureInspector.TextureFile.ImageFormatType.BC7, // High quality compression
			OutputMipAlgorithm = TextureInspector.TextureFile.MipAlgorithm.Box,
			OutputTypeString = "2D"
		};
